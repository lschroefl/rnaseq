...
cmp split/416-day7-ctrl-ipsiCore_L001_R1_001.fastq.gz concat/416-day7-ctrl-ipsiCore_L001_R1_001.fastq.gz
...
zcat ./concat/420-day7-ctrl-ipsiCore.fastq.gz | grep @NB551534 | wc -l &&
zcat ./split/420-day7-ctrl-ipsiCore_L00*_R1_001.fastq.gz | grep @NB551534 | wc -l
